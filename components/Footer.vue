<template>
  <footer class="text-center text-white" style="background-color: var(--main-background-color-dark);">
    <div class="container pt-9  mx-auto ">
      <div class="flex justify-center mb-9">
        <a href="#!" class="mr-9 text-color-main">
    ...
    <div class="text-center p-4 text-color-main" style="background-color: rgba(0, 0, 0, 0.2);">
      <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.es">
        <img src="../assets/license/ccheart_black.svg" alt="license" class="logo-license" />
      </a>
      {{ currentYear }}
      <a href="https://tailwind-elements.com/">Victor Hugo</a>
    </div>
  </footer>
